...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.orbitarc.service.impl.PasswordTokenManager#generateRecoveryToken(com.orbitarc.model.User)
     */
    @Override
    ...
    /**
     * @see com.orbitarc.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.orbitarc.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.orbitarc.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
